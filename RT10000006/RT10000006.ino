...
//Contador de ciclos de advertising
int mycounter = 0; //contador
uint8_t myctr0; //LSB //Digitos do contador
uint8_t myctr1; //.
uint8_t myctr2; //.
uint8_t myctr3; //MSB
...
static void esp_gap_cb(esp_gap_ble_cb_event_t event, esp_ble_gap_cb_param_t *param) {
  ...
  switch (event) {
    case ESP_GAP_BLE_ADV_START_COMPLETE_EVT:
      ...
      myctr3 = int(mycounter / 1000) | 0x30;
      myctr2 = int((mycounter % 1000) / 100) | 0x30;
      myctr1 = int(((mycounter % 1000) % 100) / 10) | 0x30;
      myctr0 = int(((mycounter % 1000) % 100) % 10) | 0x30;
      if (mycounter >= 9999) {
        mycounter = 0;
      } else {
        mycounter ++;
    ...
    case ESP_GAP_BLE_ADV_STOP_COMPLETE_EVT:
      delay(170); //tempo total de adv: 200ms.
      ...
      array_raw_data[myindex++] = '_';
      array_raw_data[myindex++] = myctr3;
      array_raw_data[myindex++] = myctr2;
      array_raw_data[myindex++] = myctr1;
      array_raw_data[myindex++] = myctr0;
...
void setup() {
  ...
  esp_bt_controller_deinit(); //De-initialize BT controller to free resource and delete task.
