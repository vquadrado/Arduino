...
void setup() {
  ...
  btStart(); //nao me pergunte ainda, nao sei, mas eh essencial ter isso; inicializar com esp_bt_controller_init e esp_bt_controller_enable nao consegui ainda fazer
